...
const YOUTUBE_SEED: StreamableMovie[] = [
  ...
  },
  {
    ...
    description: 'A large and lovable bunny deals with three tiny bullies in this Blender Foundation animated short. Available in 4K UHD.',
    year: 2008,
    duration: '9m 56s',
    durationSeconds: 596,
    genres: ['Animation', 'Comedy', 'Family'],
    ...
    backdrop: 'https://i.ytimg.com/vi/aqz-KE-bpKQ/maxresdefault.jpg',
    source: 'youtube',
  ...
  {
    id: 'youtube-eRsGyueVLvQ',
    title: 'Sintel (YouTube)',
    description: 'A lonely young woman befriends a dragon and embarks on a dangerous quest. Blender Foundation\'s stunning animated fantasy short film.',
    year: 2010,
    duration: '14m 48s',
    durationSeconds: 888,
    genres: ['Animation', 'Fantasy', 'Drama'],
    ...
    backdrop: 'https://i.ytimg.com/vi/eRsGyueVLvQ/maxresdefault.jpg',
    source: 'youtube',
  ...
  {
    id: 'youtube-R6MlUcmOul8',
    title: 'Tears of Steel (YouTube)',
    description: 'In an apocalyptic future, soldiers and scientists try to stop an army of robots. Blender Foundation\'s blend of live-action and CGI.',
    year: 2012,
    duration: '12m 14s',
    durationSeconds: 734,
    genres: ['Sci-Fi', 'Drama', 'Action'],
    ...
    backdrop: 'https://i.ytimg.com/vi/R6MlUcmOul8/maxresdefault.jpg',
    source: 'youtube',
  ...
  {
    id: 'youtube-WhWc3b3KhnY',
    title: 'Spring (YouTube)',
    description: 'A shepherd girl and her dog discover ancient spirits that can change the seasons. Blender Foundation\'s heartwarming animated short.',
    year: 2019,
    duration: '7m 46s',
    durationSeconds: 466,
    genres: ['Animation', 'Fantasy', 'Adventure'],
    ...
    backdrop: 'https://i.ytimg.com/vi/WhWc3b3KhnY/maxresdefault.jpg',
    source: 'youtube',
    sourceUrl: 'https://www.youtube.com/watch?v=WhWc3b3KhnY',
    sourceLicense: 'CC BY 4.0',
    videoUrl: 'https://www.youtube.com/embed/WhWc3b3KhnY?autoplay=1&rel=0',
    videoType: 'youtube',
    isEmbeddable: true,
  ...
  {
    id: 'youtube-TLkA0RELQ1g',
    title: "Elephant's Dream (YouTube)",
    description: "Two characters explore a cavernous and seemingly infinite machine. The Blender Foundation's first open movie project.",
    year: 2006,
    duration: '10m 54s',
    durationSeconds: 654,
    genres: ['Animation', 'Sci-Fi', 'Drama'],
    ...
    backdrop: 'https://i.ytimg.com/vi/TLkA0RELQ1g/maxresdefault.jpg',
    source: 'youtube',
