      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-64 flex-shrink-0">
            <nav className="bg-[#12121a] border border-[#2a2a35] rounded-xl p-2 lg:sticky lg:top-24">
          ...
          <main className="flex-1 min-w-0">
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 mb-6 text-sm text-[#6b6b7b]">
              ...
              {pathname !== '/dashboard' && (
                <>
                  <ChevronRight className="w-3 h-3" />
                  <span className="text-[#a0a0b0]">{dashboardLinks.find(l => l.href === pathname)?.label || 'Page'}</span>
                </>
              )}
            </div>
