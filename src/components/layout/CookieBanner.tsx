        ...
        {!showCustomize ? (
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                  <Button onClick={handleAccept} className="bg-[#D4A853] hover:bg-[#B8922F] text-white text-sm font-medium">Accept All</Button>
          ...
          <div className="p-6">
            ...
            <div className="flex items-center gap-3">
              <Button onClick={handleCustomize} className="bg-[#D4A853] hover:bg-[#B8922F] text-white text-sm font-medium">Save Preferences</Button>
