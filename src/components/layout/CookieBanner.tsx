        ...
        {!showCustomize ? (
          <div className="p-6">
            <div className="flex items-start gap-4">
              <Cookie className="w-8 h-8 text-[#8B5CF6] flex-shrink-0 mt-0.5" strokeWidth={1.5} />
              <div className="flex-1">
                ...
                <p className="text-sm text-[#9ca3af] leading-relaxed mb-4">
                  ...
                  <a href="/cookies" className="text-[#8B5CF6] hover:underline">Learn more</a>
                </p>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                  <Button onClick={handleAccept} className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-white text-sm font-medium">Accept All</Button>
              ...
              <button onClick={handleReject} className="p-1 text-[#6b7280] hover:text-white transition-colors flex-shrink-0" aria-label="Close"><X className="w-4 h-4" strokeWidth={1.5} /></button>
            </div>
          </div>
        ) : (
          <div className="p-6">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center gap-4 p-3 bg-[#050507] rounded-xl border border-[#1e1e28]">
                <Shield className="w-5 h-5 text-[#22c55e] flex-shrink-0" strokeWidth={1.5} />
              ...
              <label className="flex items-center gap-4 p-3 bg-[#050507] rounded-xl border border-[#1e1e28] cursor-pointer">
                <BarChart3 className="w-5 h-5 text-[#9ca3af] flex-shrink-0" strokeWidth={1.5} />
                ...
                <input type="checkbox" checked={prefs.analytics} onChange={(e) => setPrefs({ ...prefs, analytics: e.target.checked })} className="w-5 h-5 rounded accent-[#8B5CF6]" />
              </label>
              <label className="flex items-center gap-4 p-3 bg-[#050507] rounded-xl border border-[#1e1e28] cursor-pointer">
                <Settings className="w-5 h-5 text-[#9ca3af] flex-shrink-0" strokeWidth={1.5} />
                ...
                <input type="checkbox" checked={prefs.preferences} onChange={(e) => setPrefs({ ...prefs, preferences: e.target.checked })} className="w-5 h-5 rounded accent-[#8B5CF6]" />
              </label>
            </div>
            <div className="flex items-center gap-3">
              <Button onClick={handleCustomize} className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-white text-sm font-medium">Save Preferences</Button>
