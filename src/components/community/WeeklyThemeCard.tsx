...
export default function WeeklyThemeCard({ communityId, onDiscuss }: WeeklyThemeCardProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-[#0c0c10] to-[#0c0c14] border border-[#D4A853]/20 rounded-xl overflow-hidden">
      {/* Header banner */}
      <div className="bg-gradient-to-r from-[#D4A853]/15 to-[#D4A853]/15 px-5 py-4 border-b border-[#D4A853]/10">
      ...
      <div className="p-5">
        ...
        <div className="bg-[#050507] border border-[#1e1e28] rounded-lg p-4 mb-4">
          <div className="flex items-start gap-2.5">
            <Sparkles className="w-4 h-4 text-[#D4A853] mt-0.5 flex-shrink-0" strokeWidth={1.5} />
            <div>
              <span className="text-[10px] text-[#D4A853] font-semibold uppercase tracking-wider">Discussion Prompt</span>
