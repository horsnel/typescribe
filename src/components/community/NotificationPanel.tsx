...
const SYSTEM_NOTIFICATIONS: SystemNotification[] = [
  ...
  { id: 's2', type: 'review', icon: MessageSquare, title: 'New Review', message: 'Someone just reviewed "Cosmic Drift" — check out their take on the ending.', time: '4h ago', color: 'text-[#D4A853]', read: false, link: '/movie/cosmic-drift' },
  ...
  { id: 's4', type: 'recommendation', icon: Sparkles, title: 'Pick For You', message: 'Based on your watch history, you might love "The Harvest Home" (8.6 rating).', time: '12h ago', color: 'text-[#D4A853]', read: true, link: '/movie/the-harvest-home' },
  ...
  { id: 's6', type: 'trending', icon: Star, title: 'Top Rated', message: '"The Harvest Home" just entered the Top 10 — currently rated 8.6 by users.', time: '2d ago', color: 'text-[#D4A853]', read: true, link: '/top-rated' },
];
          ...
          <div className="flex items-center gap-2">
            {totalUnread > 0 && (
              <button
                ...
                className="text-[10px] text-[#D4A853] hover:text-[#B8922F] transition-colors flex items-center gap-1"
              >
