...
const CATEGORY_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  social: { bg: 'bg-[#D4A853]/10', text: 'text-[#D4A853]', border: 'border-[#D4A853]/20' },
...
const TIER_COLORS: Record<string, string> = {
  Platinum: 'from-[#E8C97A] to-[#B8922F]',
  Gold: 'from-[#D4A853] to-[#B8922F]',
      ...
      <div className="p-5 border-b border-[#1e1e28]/50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#D4A853]/20 to-[#D4A853]/20 border border-[#D4A853]/30 flex items-center justify-center">
