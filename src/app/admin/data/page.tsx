      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className={`rounded-xl border p-5 ${
              ...
              <div className="flex items-center gap-3 mb-3">
                <Activity className={`w-5 h-5 ${
                  ...
                  health.overallStatus === 'degraded' ? 'text-[#D4A853]' : 'text-red-400'
                }`} strokeWidth={1.5} />
        ...
        <section className="mb-10">
          ...
          <div className="rounded-xl border border-[#1e1e28] bg-[#0c0c10] backdrop-blur-xl p-6">
            ...
            <Button onClick={handleBatchProcess} disabled={batchProcessing || !batchInput.trim()} className="bg-[#D4A853] hover:bg-[#B8922F] text-white">
