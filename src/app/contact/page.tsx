  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] pt-8 pb-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12 py-8">
        ...
        <p className="text-[#6b6b7b] mb-10 max-w-xl">Have a question, feedback, or want to suggest a movie? We would love to hear from you. Our team typically responds within 24 hours.</p>

        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 mb-16">
          {/* Contact Form */}
          <div>
            {sent ? (
              <div className="bg-[#12121a] border border-[#2a2a35] rounded-xl p-10 text-center">
                <Mail className="w-14 h-14 text-[#e50914] mx-auto mb-4" />
                <h2 className="text-xl font-bold text-white mb-2">Message Sent!</h2>
                <p className="text-[#a0a0b0] mb-1">Thank you for reaching out. We will get back to you as soon as possible.</p>
                <p className="text-sm text-[#6b6b7b]">Typical response time: within 24 hours</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4 bg-[#12121a] border border-[#2a2a35] rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input name="name" type="text" required className="w-full bg-[#0a0a0f] border border-[#2a2a35] rounded-lg py-2.5 px-3 text-white placeholder:text-[#6b6b7b] focus:outline-none focus:border-[#e50914]" placeholder="Your name" />
                  </div>
                  <div>
                    <label className="text-sm font-medium text-white mb-1.5 block">Email</label>
                    <input name="email" type="email" required className="w-full bg-[#0a0a0f] border border-[#2a2a35] rounded-lg py-2.5 px-3 text-white placeholder:text-[#6b6b7b] focus:outline-none focus:border-[#e50914]" placeholder="you@example.com" />
                  </div>
                </div>

                <div>
                  <label className="text-sm font-medium text-white mb-1.5 block">Subject</label>
                  <select name="subject" value={subject} onChange={(e) => setSubject(e.target.value)} className="w-full bg-[#0a0a0f] border border-[#2a2a35] rounded-lg py-2.5 px-3 text-white focus:outline-none focus:border-[#e50914]">
                ...
                <div>
                  ...
                  <textarea name="message" rows={6} required className="w-full bg-[#0a0a0f] border border-[#2a2a35] rounded-lg py-2.5 px-3 text-white placeholder:text-[#6b6b7b] focus:outline-none focus:border-[#e50914] resize-none" placeholder="Tell us what's on your mind..." />
                </div>

                <Button type="submit" disabled={loading} className="bg-[#e50914] hover:bg-[#b20710] text-white gap-2 disabled:opacity-60">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#6b6b7b]">hello@typescribe.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#6b6b7b]">Usually within 24 hours</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#6b6b7b]">San Francisco, CA & Remote</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#12121a] border border-[#2a2a35] rounded-xl p-5">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex justify-between items-center py-2 border-b border-[#2a2a35]">
                  <span className="text-[#a0a0b0]">Press & Media</span>
                  <span className="text-white">press@typescribe.com</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-[#2a2a35]">
                  <span className="text-[#a0a0b0]">Partnerships</span>
                  <span className="text-white">partners@typescribe.com</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-[#2a2a35]">
                  <span className="text-[#a0a0b0]">DMCA / Legal</span>
                  <span className="text-white">dmca@typescribe.com</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-[#a0a0b0]">Privacy</span>
        ...
        <div>
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-[#12121a] border border-[#2a2a35] rounded-xl overflow-hidden">
                <button
                  onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  className="w-full flex items-center justify-between p-5 text-left hover:bg-[#1a1a25] transition-colors"
                >
                  <span className="text-sm font-medium text-white pr-4">{faq.q}</span>
                  {openFaq === i ? <ChevronUp className="w-4 h-4 text-[#e50914] flex-shrink-0" /> : <ChevronDown className="w-4 h-4 text-[#6b6b7b] flex-shrink-0" />}
                </button>
                {openFaq === i && (
