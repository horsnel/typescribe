              ...
              <form onSubmit={handleSubmit} className="space-y-4 bg-[#0c0c10] border border-[#1e1e28] rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input name="name" type="text" required className="w-full bg-[#050507] border border-[#1e1e28] rounded-lg py-2.5 px-3 text-white placeholder:text-[#6b7280] focus:outline-none focus:border-[#e50914]" placeholder="Your name" />
                  </div>
                  <div>
                    <label className="text-sm font-medium text-white mb-1.5 block">Email</label>
                    <input name="email" type="email" required className="w-full bg-[#050507] border border-[#1e1e28] rounded-lg py-2.5 px-3 text-white placeholder:text-[#6b7280] focus:outline-none focus:border-[#e50914]" placeholder="you@example.com" />
                  </div>
                </div>

                <div>
                  <label className="text-sm font-medium text-white mb-1.5 block">Subject</label>
                  <select name="subject" value={subject} onChange={(e) => setSubject(e.target.value)} className="w-full bg-[#050507] border border-[#1e1e28] rounded-lg py-2.5 px-3 text-white focus:outline-none focus:border-[#e50914]">
                ...
                <div>
                  ...
                  <textarea name="message" rows={6} required className="w-full bg-[#050507] border border-[#1e1e28] rounded-lg py-2.5 px-3 text-white placeholder:text-[#6b7280] focus:outline-none focus:border-[#e50914] resize-none" placeholder="Tell us what's on your mind..." />
                </div>
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="bg-[#0c0c10] border border-[#1e1e28] rounded-xl overflow-hidden">
                ...
                >
                  ...
                  {openFaq === i ? <ChevronUp className="w-4 h-4 text-[#e50914] flex-shrink-0" /> : <ChevronDown className="w-4 h-4 text-[#6b7280] flex-shrink-0" />}
                </button>
                {openFaq === i && (
