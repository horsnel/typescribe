          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 mb-8">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 flex-wrap mb-4">
                <span className={`text-xs font-bold px-2 py-0.5 rounded ${movie.quality === '4K' ? 'bg-[#d4a853] text-black' : movie.quality === '1080p' ? 'bg-blue-500/80 text-white' : 'bg-white/10 text-white/70'}`}>
                  {movie.quality}
                </span>
                {movie.year > 0 && (
