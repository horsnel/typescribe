          ...
          <div className="flex flex-col md:flex-row gap-6 lg:gap-10 items-end w-full">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="hero-animate flex items-center gap-3 mb-5 flex-wrap">
                ...
                {/* Score Badge */}
                {anime.score !== null && (
                  <span className="inline-flex items-center gap-1.5 text-sm font-semibold bg-[#e50914]/15 text-[#e50914] px-3 py-1 rounded-full border border-[#e50914]/25">
              ...
              <div className="hero-animate flex gap-2 flex-wrap mb-5">
                ...
                {anime.themes.map((theme) => (
                  <span
                    key={theme}
                    className="text-xs font-medium text-[#e50914] bg-[#e50914]/10 border border-[#e50914]/20 px-2.5 py-1 rounded-full"
                  >
                    {theme}
                  </span>
                ))}
              ...
              <div className="hero-animate flex items-center gap-3 flex-wrap">
                {anime.trailerYoutubeId && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium bg-[#e50914] hover:bg-[#b20710] text-white transition-colors"
                  >
                  ...
                  <>
                    ...
                    {isSynopsisLong && (
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-[#e50914] hover:underline mt-3 text-sm font-medium"
                      >
