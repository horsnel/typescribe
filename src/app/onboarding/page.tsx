          ...
          <div className="flex items-center justify-between mt-6 pt-4 border-t border-[#1e1e28]">
            {step !== 'done' ? (
              <>
                ...
                <Button onClick={handleNext} className="bg-[#D4A853] hover:bg-[#B8922F] text-white gap-2">
                  Continue <ChevronRight className="w-4 h-4" strokeWidth={1.5} />
                </Button>
              </>
            ) : (
              <div className="w-full">
                <Button onClick={handleFinish} className="w-full bg-[#D4A853] hover:bg-[#B8922F] text-white">
                  Start Exploring
                </Button>
              </div>
            )}
