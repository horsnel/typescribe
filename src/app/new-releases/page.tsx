    ...
    <div className="min-h-screen bg-[#050507] pt-8 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-[#6b7280] mb-6">
          ...
          <span>/</span>
          <span className="text-[#9ca3af]">New Releases</span>
        </nav>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className={`border-[#1e1e28] bg-transparent text-white hover:bg-[#111118] hover:text-white gap-2 ${filtersOpen ? 'border-[#e50914]' : ''}`}
            >
