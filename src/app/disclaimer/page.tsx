    ...
    <div className="min-h-screen bg-[#0a0a0f] pt-8 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 py-8">
        <nav className="flex items-center gap-2 text-sm text-[#6b6b7b] mb-6">
          ...
          <span className="text-[#a0a0b0]">Disclaimer</span>
        </nav>
        ...
        <div className="space-y-6">
          <div className="bg-[#12121a] border border-[#2a2a35] rounded-xl p-6">
            ...
            <p className="text-sm text-[#a0a0b0] leading-relaxed">The information provided on Typescribe is for general informational and entertainment purposes only. While we strive to provide accurate and up-to-date information about movies, ratings, and reviews, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or availability of the information, products, services, or related graphics contained on the platform for any purpose.</p>
          </div>
