      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 py-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#0c0c10] border border-[#1e1e28] rounded-xl p-6">
            ...
            <p className="text-sm text-[#9ca3af] leading-relaxed">If you have questions about this disclaimer, please reach out at <Link href="/contact" className="text-[#e50914] hover:underline">our contact page</Link> or email legal@typescribe.com.</p>
          </div>
        </div>
