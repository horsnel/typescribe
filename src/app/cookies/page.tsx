    ...
    <div className="min-h-screen bg-[#0a0a0f] pt-8 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 py-8">
        <nav className="flex items-center gap-2 text-sm text-[#6b6b7b] mb-6">
          ...
          <span className="text-[#a0a0b0]">Cookie Policy</span>
        </nav>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <Link href="/accessibility" className="px-4 py-2 bg-[#12121a] border border-[#2a2a35] rounded-lg text-sm text-[#a0a0b0] hover:text-white hover:border-[#3a3a45] transition-colors">Accessibility</Link>
        </div>
      </div>
    </div>
  );
