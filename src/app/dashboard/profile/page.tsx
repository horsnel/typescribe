          ...
          <div className="relative mb-4">
            <div className="w-24 h-24 rounded-full overflow-hidden border-3 border-[#D4A853]/30 ring-4 ring-[#D4A853]/10">
              {user?.avatar ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-[#D4A853] to-[#B8922F] flex items-center justify-center text-white text-3xl font-bold">
                  {initials}
                </div>
              )}
            </div>
            <button
              ...
              className="absolute bottom-0 right-0 w-8 h-8 bg-[#D4A853] rounded-full flex items-center justify-center text-white hover:bg-[#B8922F] transition-colors border-2 border-[#12121a]"
            >
