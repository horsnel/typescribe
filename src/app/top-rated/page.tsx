...
export default function TopRatedPage() {
  ...
  const rankBadge = (rank: number) => {
    if (rank === 1) return <Crown className="w-6 h-6 text-[#D4A853]" strokeWidth={1.5} />;
                ...
                {filtered.slice(0, 3).map(({ rank, movie, consensus }) => (
                  <Link
                    ...
                    className={`group relative bg-gradient-to-br ${
                      rank === 1 ? 'from-[#D4A853]/10 to-[#D4A853]/5 border-[#D4A853]/30' :
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-lg font-bold text-[#D4A853]">{movie.vote_average.toFixed(1)}</span>
                      </div>
                    </div>
