...
function TopChoiceCard({ category }: { category: TopChoiceCategory }) {
  ...
  return (
    <Link
      ...
      className="flex-shrink-0 w-[220px] sm:w-[240px] md:w-[260px] group/topcard"
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6 px-6 lg:px-12">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-gradient-to-br from-[#d4a853] to-[#b8922e] rounded-xl flex items-center justify-center shadow-lg shadow-[#d4a853]/20">
