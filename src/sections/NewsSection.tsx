      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="reveal-section flex items-center justify-between mb-10">
          <div className="flex items-center gap-3">
            <Newspaper className="w-6 h-6 text-[#d4a853]" />
            <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Latest Movie News</h2>
          </div>
          <Link href="/news" className="flex items-center gap-1.5 text-sm text-[#9ca3af] hover:text-[#d4a853] transition-colors">All News<ArrowUpRight className="w-4 h-4" /></Link>
        </div>
        {loading ? (
