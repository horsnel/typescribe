    ...
    <section className="py-20 bg-[#12121a]">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="reveal-section flex items-center justify-between mb-10">
          ...
          <Link href="/browse" className="flex items-center gap-1.5 text-sm text-[#a0a0b0] hover:text-[#e50914] transition-colors">View All<ArrowRight className="w-4 h-4" /></Link>
        </div>
